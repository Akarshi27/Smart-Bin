...
import { Bell, User, QrCode, Download, Leaf, Award, Flame, Star, MapPin, Activity, CheckCircle, AlertTriangle, Loader, Hash, Gift, Ticket, ArrowRight, Server, X } from 'lucide-react';
...
export default function UserDashboard() {
  ...
  const [showGreenInitiatives, setShowGreenInitiatives] = useState(false);
      ...
      <div className="ud-dashboard-wrapper">
        ...
        <main className="ud-main">
          ...
          <div className="ud-menu-bar">
            ...
            <button 
              className="ud-menu-tab ud-go-green-tab" 
              onClick={() => setShowGreenInitiatives(true)}
              style={{ marginLeft: 'auto', background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', color: 'white', fontWeight: 'bold' }}
            >
              <Leaf size={16} className="ud-gg-icon" /> Go Green
            </button>
          </div>
            ...
            <>
              ...
              <div className="ud-stats-grid">
                {[
                  ...
                  { title: 'Current Streak', value: `1 Day`, icon: <Flame color="#f97316" size={20} />, color: 'orange', badge: 'Personal Best', trend: 'Keep it up!' },
          ...
          {activeTab === 'map' && (
            <div className="ud-panel" style={{ marginBottom: '2rem' }}>
              ...
              <div style={{ height: '400px', borderRadius: '0.75rem', overflow: 'hidden', border: '1px solid #e2e8f0' }}>
                <MapContainer center={[28.6297, 77.4369]} zoom={15} style={{ height: '100%', width: '100%' }}>
                  <TileLayer url="https://{s}.basemaps.cartocdn.com/rastertiles/voyager/{z}/{x}/{y}{r}.png" />
                  <Marker position={[28.6297, 77.4369]}>
                    <Popup>
                      <strong style={{ color: '#1e293b' }}>ABESIT College Bin</strong><br />
        ...
        {/* GO GREEN INITIATIVES POPUP */}
        {showGreenInitiatives && (
          <div className="ud-gg-modal-overlay">
            <div className="ud-gg-modal">
              <div className="ud-gg-modal-header">
                <h3><Leaf size={20} color="#10b981" /> Go Green Initiatives</h3>
                <button className="ud-gg-close" onClick={() => setShowGreenInitiatives(false)}>
                  <X size={20} />
                </button>
              </div>
              <div className="ud-gg-modal-content">
                <div className="ud-gg-hero">
                  <h4>Our Planet Needs You! 🌍</h4>
                  <p>Join our community-driven mission to keep the environment clean, sustainable, and thriving. Every small step counts.</p>
                </div>
                
                <div className="ud-gg-cards">
                  <div className="ud-gg-card">
                    <div className="ud-gg-icon-wrapper bg-green"><Leaf size={20} color="#10b981"/></div>
                    <div className="ud-gg-card-text">
                      <h5>Reduce & Recycle</h5>
                      <p>Ensure waste is segregated at source. Use smart bins.</p>
                    </div>
                  </div>
                  
                  <div className="ud-gg-card">
                    <div className="ud-gg-icon-wrapper bg-blue"><Activity size={20} color="#3b82f6"/></div>
                    <div className="ud-gg-card-text">
                      <h5>Conserve Energy</h5>
                      <p>Turn off unused appliances and fix leaking taps.</p>
                    </div>
                  </div>
                  
                  <div className="ud-gg-card">
                    <div className="ud-gg-icon-wrapper bg-orange"><Flame size={20} color="#f97316"/></div>
                    <div className="ud-gg-card-text">
                      <h5>Eco-Transport</h5>
                      <p>Carpool, use public transit, or bike for local trips.</p>
                    </div>
                  </div>

                  <div className="ud-gg-card">
                    <div className="ud-gg-icon-wrapper bg-purple"><Star size={20} color="#8b5cf6"/></div>
                    <div className="ud-gg-card-text">
                      <h5>Ditch Plastics</h5>
                      <p>Carry a reusable bag, metal straw, and water bottle.</p>
                    </div>
                  </div>
                </div>

                <div className="ud-gg-footer">
                  <button className="ud-gg-pledge-btn" onClick={() => setShowGreenInitiatives(false)}>
                    <CheckCircle size={18} /> I Pledge to Go Green
                  </button>
                </div>
              </div>
            </div>
