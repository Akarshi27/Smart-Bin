        ...
        {!selectedRole ? (
          <div className="role-selection-view">
            <div className="auth-header-wrapper">
              <TextType as="h1" text="Welcome to EcoTech" typingSpeed={60} cursorCharacter="|" />
          ...
          <>
            ...
            <div className="auth-header-wrapper">
              <TextType as="h1" text={mode === 'signup' ? "Join EcoTech" : "Access EcoTech"} typingSpeed={60} cursorCharacter="|" />
